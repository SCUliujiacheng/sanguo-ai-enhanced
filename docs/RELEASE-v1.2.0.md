...
在下方 Assets 下载 **sanguo-ai-enhanced-v1.2.0.apk**。Source code ZIP/TAR 不是安装包。

- 原有 5 期加上 7 个历史时期、2 个架空挑战，共 **14 个剧本**；菜单用“上一页 / 下一页”切换。
...
**更新**：版本号 1.2.0，versionCode 2。签名与上一“经济修复与 AI 优化”修改版一致，可尝试覆盖更新；先保护重要存档。来源版签名不同，不能直接覆盖。不要为解决安装问题直接卸载有重要进度的旧版。

**已验证**：最终程序集 29 项经济/AI 回归和 44 项时期/搜将测试通过；APK 签名、对齐及逐项内容校验通过。包含全部 14 期初始化和存读往返。**尚未在 Android 上安装或实玩验收**，手机画面、触摸和覆盖更新仍需设备验证。
